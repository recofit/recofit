          ...
          <div class="information-content">
            ...
            <div class="row">
              <div class="section-title">
                <h1 style="white-space: nowrap; font-size: 30px">
                  {{ result.title }}
                </h1>
                <button
                  type="button"
                  class="btn btn-review btn-outline-primary"
            ...
            <p style="font-size: 16px">
              <span v-if="result.venue != null"
                ><b>주소</b><br />
                {{ result.venue }} <br /><br
              /></span>
              <span v-if="result.subjectCategory != null"
                ><b>카테고리</b><br />
                {{ result.subjectCategory }} <br /><br
              /></span>
              <span v-if="result.description != null"
                ><b>찾아오시는 길</b><br />
                {{ result.description }} <br /><br
              /></span>
              <span v-if="result.subDescription != null"
                ><b>기타 정보</b><br />
                {{ result.subDescription }} <br /><br
              /></span>
              <span v-if="result.reference != null"
                ><b>연락처</b><br />
                {{ result.reference }} <br /><br
              /></span>
              <span v-if="result.source != null"
                ><b>웹사이트</b><br />
                {{ result.source }} <br /><br
              /></span>
            </p>
