      ...
      <div class="container b-container" id="b-container">
        <div class="forms" id="b-form">
          ...
          <div style="display:flex; align-items:center;">
            ...
            <button class="duplication__box" @click="emailDuplicationCheckAndSendMessage">인증메일</button>
          </div>
          <div style="display:flex; align-items:center;">
              <input class="form__input" type="text" v-model="code" placeholder="인증번호">
              <button class="duplication__box" @click="emailVerify">인증하기</button>
            </div>
          <div style="display:flex; align-items:center;">
